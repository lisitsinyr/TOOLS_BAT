...
rem 
rem Description:
rem   Spawns a shell within the virtual environment.
...
rem 
rem Help:
rem   The shell command spawns a shell, according to the
rem   $SHELL environment variable, within the virtual environment.
rem   If one doesn't exist yet, it will be created.
rem -------------------------------------------------------------------
chcp 1251>NUL

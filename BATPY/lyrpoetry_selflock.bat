...
Description:
  ...
  The self lock command reads this Poetry installationís system pyproject.toml file. The system dependencies are locked in the corresponding poetry.lock file.
...
rem -------------------------------------------------------------------
rem   Usage 
rem   The self lock command reads this Poetry installationís system pyproject.toml file. The system dependencies are locked in the corresponding poetry.lock file.

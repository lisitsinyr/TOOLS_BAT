@echo off
rem -------------------------------------------------------------------
rem lyrpoetry_sourceshow.bat
rem -------------------------------------------------------------------
rem Запуск poetry из глобального виртуального пространства
rem -------------------------------------------------------------------
rem 
rem Description:
rem   Show information about sources configured for the project.
rem   The source show command displays information on all configured sources for the project.
rem 
rem Usage:
rem   source show [options] [--] [<source>...]
rem 
rem Arguments:
rem   source                     Source(s) to show information for. Defaults to showing all sources.
rem 
rem Options:

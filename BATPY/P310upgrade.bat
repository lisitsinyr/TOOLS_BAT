...
rem -------------------------------------------------------------------
rem P310upgrade.bat
rem     Upgrade виртуального окружения P310
rem -------------------------------------------------------------------
chcp 1251>NUL
...
rem beginfunction
    ...
    C:\Users\lyr\AppData\Local\Programs\Python\Python310\python.exe -m venv --upgrade D:\PROJECTS_LYR\CHECK_LIST\05_DESKTOP\02_Python\VENV\P310

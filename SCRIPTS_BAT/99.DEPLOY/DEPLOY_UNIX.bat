...
:begin
    ...
    call :DEPLOY_PROJECT !LPROJECTS_GROUP! COMMANDS_SH

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! PATTERN_SH

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! PROJECTS_SH
    
    call :DEPLOY_PROJECT !LPROJECTS_GROUP! SCRIPTS_SH

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! SOFTWARE
    
    call :DEPLOY_PROJECT !LPROJECTS_GROUP! TESTS_SH

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! TOOLS_SRC_SH

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! TRICKS

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! UBUNTU

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! TOOLS_SH

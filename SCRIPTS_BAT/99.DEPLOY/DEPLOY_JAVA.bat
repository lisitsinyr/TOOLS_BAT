...
:begin
    ...
    rem 
    rem -------------------------------------------------------------------
    set LPROJECTS_GROUP=JAVA
    set LPROJECTS_GROUP_INI=D:\PROJECTS_LYR\CHECK_LIST\DESKTOP\Java\JAVA.ini
    ...
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! LIBRARY_JAVA
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! PATTERN_JAVA
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! PATTERNS_JAVA
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! PROJECTS_JAVA
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! SCRIPTS_JAVA
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! SOFTWARE_JAVA
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! TESTS_JAVA
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! TOOLS_SRC_JAVA
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! TOOLS_JAVA

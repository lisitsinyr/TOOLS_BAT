...
:begin
    ...
    rem 
    rem -------------------------------------------------------------------
    set PROJECTS_GROUP=PROJECTS_BAT
    ...
    rem -------------------------------------------------------------------
    set PROJECTS_DIR_ROOT=!PROJECTS_LYR_DIR!\CHECK_LIST\SCRIPT\BAT
    ...
    rem set PROJECT_NAME=TESTS_BAT
    rem call :DEPLOY_PROJECT
    ...
    rem PROJECTS_DIR_ROOT - каталог группы проектов
    rem -------------------------------------------------------------------
    set PROJECTS_DIR_ROOT=!PROJECTS_LYR_DIR!\CHECK_LIST\SCRIPT
    rem echo PROJECTS_DIR_ROOT:!PROJECTS_DIR_ROOT!

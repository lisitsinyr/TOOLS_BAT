...
:begin
    ...
    rem set DIR_GROUP_ROOT=D:\PROJECTS_LYR\CHECK_LIST\SCRIPT\BAT
    rem cd /d "D:\PROJECTS_LYR\CHECK_LIST\SCRIPT\BAT\TOOLS_BAT"
    rem call DEPLOY_PROJECT_TOOLS_BAT.bat
    call :DEPLOY_PROJECT

...
rem ---------------
rem 3.git push TOOLS_PY:
rem ---------------
rem call D:\PROJECTS_LYR\CHECK_LIST\05_DESKTOP\02_Python\PROJECTS_PY\TOOLS_PY\lyrgit_push_main.bat
set DIR_TOOLS_PY=D:\PROJECTS_LYR\CHECK_LIST\05_DESKTOP\02_Python\PROJECTS_PY\TOOLS_PY
cd /D %DIR_TOOLS_PY%

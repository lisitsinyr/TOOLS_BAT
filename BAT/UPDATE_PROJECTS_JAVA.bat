...
rem ---------------
rem 3.git push PROJECTS_JAVA:
rem ---------------
rem call D:\PROJECTS_LYR\CHECK_LIST\05_DESKTOP\03_Java\PROJECTS_JAVA\PROJECTS_JAVA\lyrgit_push_main.bat
set DIR_PROJECTS_JAVA=D:\PROJECTS_LYR\CHECK_LIST\05_DESKTOP\03_Java\PROJECTS_JAVA\PROJECTS_JAVA
cd /D %DIR_PROJECTS_JAVA%

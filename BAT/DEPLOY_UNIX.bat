...
:begin
    ...
    rem 
    rem -------------------------------------------------------------------
    set PROJECTS_GROUP=PROJECTS_UNIX
    ...
    rem -------------------------------------------------------------------
    set PROJECTS_DIR_ROOT=!PROJECTS_LYR_DIR!\CHECK_LIST\OS\UNIX
    ...
    rem PROJECTS_DIR_ROOT - каталог группы проектов
    rem -------------------------------------------------------------------
    set PROJECTS_DIR_ROOT=!PROJECTS_LYR_DIR!\CHECK_LIST\OS
    rem echo PROJECTS_DIR_ROOT:!PROJECTS_DIR_ROOT!

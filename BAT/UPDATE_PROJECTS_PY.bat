...
rem ---------------
rem 3.git push PROJECTS_PY:
rem ---------------
rem call D:\PROJECTS_LYR\CHECK_LIST\05_DESKTOP\02_Python\PROJECTS_PY\PROJECTS_PY\lyrgit_push_main.bat
set DIR_PROJECTS_PY=D:\PROJECTS_LYR\CHECK_LIST\05_DESKTOP\02_Python\PROJECTS_PY\PROJECTS_PY
cd /D %DIR_PROJECTS_PY%

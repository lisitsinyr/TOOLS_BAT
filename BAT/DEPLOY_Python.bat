...
:begin
    ...
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! APPInfo_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! DeepSeek
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! HelloWorld
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! LIBRARY_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! lyrpy2
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! lyrpy2-example
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! MobileAPP_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! OBJECTS
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! PATTERNS_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! PATTERN_lib
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! PATTERN_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! PROJECTS_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! sampleproject
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! SCRIPTS_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! SOFTWARE_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! test
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! TESTS_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! TEST_P312
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! TEST_P313
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! TEST_P314
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! TOOLS_SRC_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! TRICKS
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! WEB_SCRIPTS
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! YOUTUBE_PY
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! YOUTUBE_pytube
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! YOUTUBE_yt-dlp
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! YOUTUBE_yt-downloader-multi
    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! YTSage

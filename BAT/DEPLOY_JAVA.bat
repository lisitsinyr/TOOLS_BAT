...
:begin
    ...
    call :DEPLOY_PROJECT !LPROJECTS_GROUP! LIBRARY_JAVA

    rem call :DEPLOY_PROJECT !LPROJECTS_GROUP! PATTERN_JAVA

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! PATTERNS_JAVA
    
    call :DEPLOY_PROJECT !LPROJECTS_GROUP! PROJECTS_JAVA
    
    call :DEPLOY_PROJECT !LPROJECTS_GROUP! SCRIPTS_JAVA

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! SOFTWARE_JAVA

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! TESTS_JAVA
    
    call :DEPLOY_PROJECT !LPROJECTS_GROUP! TOOLS_SRC_JAVA

    call :DEPLOY_PROJECT !LPROJECTS_GROUP! TOOLS_JAVA
